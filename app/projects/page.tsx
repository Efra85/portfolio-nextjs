    ...
    try {
      const response = await fetch(
        "https://api-springboot-ia.onrender.com/incidents",
        {
          ...
          // AJUSTE CRUCIAL: Adicionado 'title' para satisfazer o Record Java
          body: JSON.stringify({
            title: "Incidente via Web",
      ...
      if (!response.ok) {
        // Se houver erro de validação (como o 400), mostraremos a mensagem do Java
        throw new Error(data.message || "Erro na resposta da API");
      }

      // Exibe o resultado da classificação da IA
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Erro ao conectar com a API Java.";
